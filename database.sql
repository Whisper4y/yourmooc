...
-- ----------------------------
INSERT INTO `t_site_carousel` VALUES (null, 'React.js入门与实战',        'c1.jpg', 'http://www.baidu.com', '5');
INSERT INTO `t_site_carousel` VALUES (null, 'AngularJS模仿拉钩网',       'c2.jpg', 'http://www.baidu.com', '4');
INSERT INTO `t_site_carousel` VALUES (null, '成为更高级的android工程师', 'c3.jpg', 'http://www.baidu.com', '3');
INSERT INTO `t_site_carousel` VALUES (null, '玩转算法面试',              'c4.jpg', 'http://www.baidu.com', '2');
...
-- ----------------------------
INSERT INTO `t_course_comment` (`id`, `username`, `to_username`, `course_id`, `section_id`, `section_title`, `content`, `create_time`)
VALUES
	(1, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(2, 'lisi', 'zhangsan', 1, 12, '1-2 Java讲的真好', '我是评论我是评论', '2018-03-14 22:11:07'),
	(3, 'zhangsan', '', 1, 12, '1-2 Java讲的真好', '我是评论我是评论', '2018-03-14 22:11:07'),
	(4, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(5, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(6, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(7, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(8, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(9, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(10, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(11, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(12, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(13, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(14, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(15, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(16, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(17, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(18, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(19, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(20, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(21, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(22, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(23, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(24, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(25, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(26, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(27, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(28, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(29, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(30, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07'),
	(31, 'zhangsan', 'lisi', 1, 12, '1-1 使用RecyclerView优雅实现复杂布局-课程介绍', '我是评论我是评论', '2018-03-14 22:11:07');
