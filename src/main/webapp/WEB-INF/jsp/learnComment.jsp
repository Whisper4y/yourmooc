		...
		<div class="f-main clearfix">
			...
			<div class="main-course-left">
					<div class="course-info">
						...
						<div class="course-menu">
							...
							<a  href="<%=path %>/courseComment/segment?courseId=${courseId}&pageNum=1"><span class="menu-item <c:if test="${isComment == 'yes'}">cur</c:if>">评论</span></a>
						</div>
			</div>
				<!-- 基本信息-end -->
			...
			<div class="main-course-right"  >
				...
				<c:forEach items="${recomdCourseList}" var="recomdCourse" varStatus="status">
					<a href="#/${recomdCourse.id}" class="mb-5" target="_black">
