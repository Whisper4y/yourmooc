			...
			<div class="main-course-left">
					<div class="course-info">
						...
						<div class="course-video">
							<video src="<%=basePath %>resources/${courseSection.videoUrl}" width="100%" height="100%" controls preload></video>
						</div>
						...
						<div class="comment clearfix">
							...
							<div class="comment-main">
								...
								<div class="comment-footer">
									<span>时间：<fmt:formatDate value="${item.createTime }" pattern="yyyy-MM-dd HH:mm:ss"/> </span> <a href="">${item.sectionTitle }</a>
								</div>
							</div>
						</div>
					</c:forEach>
