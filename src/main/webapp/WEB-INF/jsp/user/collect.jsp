				...
				<c:forEach var="item" items="${page.items}">
					<div class="comment clearfix">
						<div class="comment-main" style="width: 100%">
							<a href="<%=path %>/course/learn/${item.courseId}" class="user-name link-a" style="font-size:20px;">
									${item.courseName}
							</a>
							<div class="comment-content">
									<span>收藏时间：<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${item.createTime}" />
									</span>
							</div>
						</div>
					</div>
