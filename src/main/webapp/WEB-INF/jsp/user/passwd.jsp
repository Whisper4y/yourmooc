...
<div class="f-main clearfix">
	...
	<div class="setting-right">
		...
		<form class="oc-form" id="passwdForm" method="post" action="<%=path %>/user/savePasswd">
			<li><label>旧密码</label> <input id="oldPassword" name="oldPassword" type="password" class="input-text"
																		placeholder="请输入旧密码" autocomplete="off"/></li>
			<li><label>新密码</label> <input name="password" type="password" class="input-text" placeholder="请输入新密码"
																		autocomplete="off"/></li>
			<li><label>确认密码</label> <input name="rePassword" type="password" class="input-text" placeholder="请输入确认密码"
																		 autocomplete="off"/></li>
