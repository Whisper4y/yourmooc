	...
	<body>
		...
		<div class="f-main">
			<div class="types-block clearfix" style="text-align: center;">
				...
				<form id="registerForm" method="post" action="<%=path %>/auth/doRegister" class="oc-form"  style="text-align: center;border: 1px solid #CCC;width: 600px;margin:0 auto;padding:20px;" >
						<li><label>用户名</label> 
							<input maxlength="20" id="username" name="username"  type="text"  class="input-text"  placeholder="请输入用户名（仅限于英文和数字）" >
						</li>
						<li><label>密码</label> 
						...
						<a class="vali-base"><img  onclick="reloadIndityImg('indeityImgRegister');" id="indeityImgRegister"  src="<%=path %>/identiry/code" style="width:80px;height:40px;float:left;margin-left:10px;"/></a>
						</li>
