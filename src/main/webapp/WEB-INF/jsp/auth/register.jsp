...
<div class="f-main">
	<div class="types-block clearfix" style="text-align: center;">
		...
		<form id="registerForm" method="post" action="<%=path %>/auth/doRegister" class="oc-form"
			...
			<li><label>用户名</label>
				<input maxlength="20" id="username" name="username" type="text" class="input-text"
							 placeholder="请输入用户名（仅限于英文和数字）">
			</li>
			<li><label>密码</label>
				<input maxlength="20" id="password" name="password" type="password" class="input-text" placeholder="请输入密码"
							 autocomplete="off"/>
			</li>
			<li><label>验证码</label>
				<input id="identiryCode" name="identiryCode" maxlength="6" class="input-text" type="text" style="width: 150px;"
							 placeholder="请输入验证码"/>
